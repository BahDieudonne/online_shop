    ...
    <footer className="bg-navy-900 text-gray-300">
      ...
      <div className="bg-gradient-to-r from-navy-800 to-purple-900 py-10">
        <div className="container mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-6">
          <div>
            ...
            <p className="text-gray-300 text-sm mt-1">Get exclusive deals, new arrivals and more — delivered to your inbox.</p>
          </div>
          {subscribed ? (
            <div className="flex items-center gap-2 text-gold-400 font-semibold"><CheckCircleIcon className="w-5 h-5" /> You're subscribed! Thank you.</div>
          ) : (
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8">
          ...
          {/* Help */}
          <div>
            <h4 className="font-semibold text-white mb-4">Help & Info</h4>
            <ul className="space-y-2 text-sm">
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-2">
              {['MTN MoMo', 'Orange Money', 'Stripe', 'PayPal', 'Bank Transfer', 'Cash on Delivery'].map((pm) => (
      ...
      <div className="border-t border-navy-700 py-4">
        <div className="container mx-auto px-4 flex flex-col md:flex-row justify-between items-center gap-2 text-xs text-gray-500">
          <span className="flex items-center gap-1 flex-wrap">© {new Date().getFullYear()} CHANCELOR STORE. All rights reserved. Made with <HeartIcon className="w-3.5 h-3.5 text-red-400 fill-red-400 inline" /> in Cameroon</span>
